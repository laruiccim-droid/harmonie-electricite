  ...
  for (const item of queue) {
    ...
    try {
      ...
      const description = [
        ...
        '',
        '─────────────────────',
        '💶 Total HT  : ' + (doc.totalHT||0).toFixed(2) + ' €',
        '💶 TVA ' + (doc.tvaRate||20) + '%   : ' + (doc.totalTVA||0).toFixed(2) + ' €',
